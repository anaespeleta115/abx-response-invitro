...
eAME004_mixture_compositions <- eAME004_data %>% filter(replicate == curr_replicate) %>% 
...
savePNGPDF(paste0(OUTDIR, "eAME004_mixture_compositions"), eAME004_mixture_compositions, 3, 15)
...
eAME004_donor_compositions <- eACE010_data %>% filter(biosample %in% donor_communities) %>% 
