...
source("analysis/plotDefaults.R")
# Import study metadata.
source("analysis/background/background.R")
...
PALETTE.SPECIESTRAJECTORIES <- c("lightgray","gray","#117733","#332288","#882255")
names(PALETTE.SPECIESTRAJECTORIES) <- c("notDisrupted","notClassified","recovered","notRecovered","colonized")
PALETTE.SPECIESTRAJECTORIESTEXT <- c("gray30","gray","#117733","#332288","#882255")
names(PALETTE.SPECIESTRAJECTORIESTEXT) <- c("notDisrupted","notClassified","recovered","notRecovered","colonized")
