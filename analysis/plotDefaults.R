...
savePNGPDF <- function(name, plot, height, width){
  save_plot(paste0(name,".png"), plot, base_height=height, base_width=width, bg = "white")
  save_plot(paste0(name,".pdf"), plot, base_height=height, base_width=width, bg = "white")
}
...
# Write a function to convert p-values to significance asterisks.
