...
# Subsample the XBB followup timepoints to be approximately every other month.
samplesXBBextraFollowup <-
  c("XBB-136", "XBB-204", "XBB-274", "XBB-330", "XBB-380", "XBB-422", 
    "XBB-430", "XBB-443", "XBB-464", "XBB-493", "XBB-499", "XBB-555",
    "XBB-582", "XBB-597", "XBB-625", "XBB-656", "XBB-701", "XBB-725",
    "XBB-745", "XBB-773", "XBB-811")
