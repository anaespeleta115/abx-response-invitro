...
subject_composition_plot_day64 <- subject_composition("XDB-029+XDA-064", "XDB-029", "XDA-064", 1) + theme_cowplot()
...
ggsave(
  filename = file.path(OUTPUTDIR, "compositions_XDBXDA.png"),
  plot = combined_plot,
  width = 10,
  height = 10,
  dpi = 600,
