...
I was thinking that we would want to compare the average distance (i.e. JSD) between two in vivo communities (passage 0), compared to two in vitro communities (passage 8).
...
beta_diversity_wide <- beta_diversity_wide%>%
  ...
  filter(!is.na(passage1), !is.na(passage2))
```
