...
# These are the ones I considered to be meaningful comparisons, but I'm actually really not sure
  ...
  valid_comparisons_2 <- c("No_001 vs No_029", "No_001 vs No_036", "No_001 vs No_064", "No_001 vs Yes_001", "No_029 vs No_036", "No_029 vs No_064", "No_029 vs Yes_029", "No_036 vs Yes_036", "No_064 vs Yes_064", "Yes_001 vs Yes_029", "Yes_001 vs Yes_036", "Yes_001 vs Yes_064", "Yes_029 vs Yes_036", "Yes_029 vs Yes_064", "Yes_036 vs Yes_064")


left_join(e0026_alpha %>%
  mutate(abxDay=paste0(antibiotic,"_",day)) %>%
  wilcox_test(Shannon~abxDay),
  e0026_alpha %>%
  mutate(abxDay=paste0(antibiotic,"_",day)) %>%
  wilcox_effsize(Shannon~abxDay),
  ...
  mutate(comparison=paste0(gsub("\n"," ",group1), " vs ", gsub("\n"," ",group2)),
     	summary=paste0("Wilcoxon rank-sum two-sided test, ", comparison, ": n=", n1+n2,
                    	...
                    	", custom adjusted p-value=", 15*p, " (number of groups: 15)")) %>% 
  filter(comparison %in% valid_comparisons_2)
